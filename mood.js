const moodOptions = {
    ...
    Gift: [
        { text: "Your Gift (Anything You Want, Bill is on Me)", action: "gift" }
    ]
};

// Add handling for the "Gift" action
function handleGiftSelection() {
    alert("Pick anything you want! 🎁 Bill is on me!");
}

// Modify the render function to handle "gift" action
